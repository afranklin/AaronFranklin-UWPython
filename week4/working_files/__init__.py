...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>__init__.py at master from shelfworthy's pyflix - GitHub</title>
...
<script src="https://assets1.github.com/javascripts/bundle_github.js?bb4c48b1a8bf07e447572a08cdd1d3ff144274ad" type="text/javascript"></script>
  ...
  <link href="https://github.com/shelfworthy/pyflix/commits/master.atom" rel="alternate" title="Recent Commits to pyflix:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = "__init__.py";
  ...
  <ul>
    <li>
      ...
      <ul>
            ...
            <li><a href="/shelfworthy/pyflix/blob/reorganize/__init__.py" action="show">reorganize</a></li>
...
<div class="flash-messages"></div>
  ...
  <div class="envelope commit">
    ...
    <div id="slider">
      ...
      <div class="breadcrumb" data-path="__init__.py/">
        <b><a href="/shelfworthy/pyflix/tree/c17c63ebd0e8ba48f2c52d809a65793c89e74a25">pyflix</a></b> / __init__.py       <span style="display:none" id="clippy_3966">__init__.py</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3966&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://assets0.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3966&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
      ...
      <div class="frames">
        <div class="frame frame-center" data-path="__init__.py/">
          
            <ul class="big-actions">
              <li><a class="file-edit-link minibutton" href="/shelfworthy/pyflix/file-edit/master/__init__.py"><span>Edit this file</span></a></li>
            </ul>
          ...
          <div id="files">
            <div class="file">
              <div class="meta">
                ...
                <ul class="actions">
                  <li><a href="/shelfworthy/pyflix/raw/master/__init__.py" id="raw-url">raw</a></li>
                  
                    <li><a href="/shelfworthy/pyflix/blame/master/__init__.py">blame</a></li>
                  
                  <li><a href="/shelfworthy/pyflix/commits/master/__init__.py">history</a></li>
                </ul>
              </div>
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="links">
          ...
          <li><a href="http://support.github.com?sso=DSINGzLJ7Xwhrb8o0pRMGTxq2zzAPrFruKlevC1vFu_MbUKJzAswHUMogTkdqmIpmP4Yc5ikO-_hRwArAzDj8syxSGQseOcHZVzQj2LWIrDGLaDfQ4_CjvihIqD_oL0z0xUVAwsnUeQTbtz_qebeN9vCG9hQGoFnKFs4PHAGiTlnC7v2QC7ofXG6DqiAml2aUE2p4JqFQBdO0pJsX5-dZ9ugEESoMQajMxB8h5cvk0M">Support</a></li>
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.27512s from fe5.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
